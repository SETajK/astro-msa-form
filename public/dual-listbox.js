(() => {
    var b = "dual-listbox",
        v = "dual-listbox__container",
        p = "dual-listbox__available",
        E = "dual-listbox__selected",
        r = "dual-listbox__title",
        c = "dual-listbox__item",
        m = "dual-listbox__buttons",
        f = "dual-listbox__button",
        u = "dual-listbox__search",
        a = "dual-listbox__item--selected",
        _ = "up",
        L = "down",
        d = class {
            constructor(t, e = {}) {
                this.setDefaults(),
                    ...
                    e.options !== void 0 && this._splitOptions(e.options),
                    this._buildDualListbox(this.select.parentNode),
                    this._addActions(),
                    this.sortable && this._initializeSortButtons(),
                    this.redraw();
            }
            setDefaults() {
                (this.addEvent = null),
            ...
            searchLists(t, e) {
                let s = e.querySelectorAll(`.${c}`),
                    i = t.toLowerCase();
                for (let l = 0; l < s.length; l++) {
                    let n = s[l];
                    n.textContent.toLowerCase().indexOf(i) === -1
            ...
            _actionAllDeselected(t) {
                t.preventDefault(),
                    this.selected
                        .filter((s) => s.style.display !== "none")
                        .forEach((s) => this.removeSelected(s));
            }
            ...
            _initReusableElements() {
                (this.dualListbox = document.createElement("div")),
                    ...
                    this.selectedList.classList.add(E),
            ...
            _selectOption(t) {
                ...
                for (let s = 0; s < e.length; s++) {
                    let i = e[s];
                    i.value === t &&
                        ((i.selected = !0), i.setAttribute("selected", ""));
                }
            ...
            _onSortButtonClick(t, e) {
                ...
                s !== i &&
                    (this._sortUnderlyingSelectOptions(s, i),
                    this._sortSelected(s, i),
                    this.redraw());
            }
            _findSelected(t) {
                let e = this.selected.findIndex((i) =>
                        i.classList.contains("dual-listbox__item--selected")
                    ),
                    s = e;
                return (
                    _ === t && e > 0
                        ? (s -= 1)
                        : L === t && e < this.selected.length - 1 && (s += 1),
                    [e, s]
                );
            }
            _sortUnderlyingSelectOptions(t, e) {
                let s = this.selected[t].getAttribute("data-id"),
                    i = this.selected[e].getAttribute("data-id"),
                    l = [...this.select.children].findIndex(
                        (o) => o.value === s
                    ),
                    n = [...this.select.children].findIndex(
                        (o) => o.value === i
                    ),
                    h = this.select.children[l];
                h.remove(),
                    this.select.insertBefore(h, this.select.children[n]);
            }
            _sortSelected(t, e) {
